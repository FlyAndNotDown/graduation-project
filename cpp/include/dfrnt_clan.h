...
namespace watermark {
    class dfrnt_clan {
        public:
            ...
            static cx_mat lqdfrnt(cx_mat source, cx_mat kernel, vec unit_pure_quaternion);
            static cx_cube lqdfrnt2(cx_cube source, unsigned int length, cx_mat kernel, vec unit_pure_quaternion);
    };
};
