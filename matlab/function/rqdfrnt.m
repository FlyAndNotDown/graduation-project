function output = rqdfrnt(source, a, m, p, u)
%rqdfrnt - one-dimension RQDFRNT
%
% - Description:
%       the one-dimension right quaternion discrete fractional random transform
%
% - Arguments:
...
%       - u [1x4 vector] a unit puer quaternion vector
% - Returns
