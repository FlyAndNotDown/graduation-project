function [output, kp, kl] = qdfrftQcMark(source, secret, ks, kt, ikt, intensityFactor)
...
%       - intensityFactor [double] the intensity of watermarking
%
% - Returns:
...
for channel = 3 : 4
    ...
    for n = 1 : blocksLength
        ...
        if adaptiveFactors(1, n) > 0
            ...
            % klCount = klCount + 1;
            intensity = intensityFactor * adaptiveFactors(1, n);
            kl(1, klCount) = intensity;
            klCount = klCount + 1;
